...
public:
	...
	static CString Translate(const CString& sLang, const CString& sFormat, const MCString& msValues);
	static CString Translate(const CString& sLang, const CString& sText);
